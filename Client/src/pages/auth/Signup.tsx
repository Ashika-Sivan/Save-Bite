...
import { User, Store, ArrowRight, ShieldCheck, Eye, EyeOff } from "lucide-react";
import axios from "axios";
import { useDispatch } from "react-redux";
import toast from "react-hot-toast";
import { GoogleLogin } from "@react-oauth/google";
import type { CredentialResponse } from "@react-oauth/google";
import { googleLogin, getVendorStatus } from "../../services/auth.service";
...
const Signup = () => {
  ...
  const handleGoogleSuccess = async (credentialResponse: CredentialResponse) => {
    ...
    try {
      ...
      setErrors((prev) => ({
        ...prev,
        email: error.response?.data?.message || error.message || "Google Signup failed.",
      }));
    } finally {
      setLoading(false);
    }
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className={inputClass(errors.password).replace("mt-1", "") + " pr-10"}
                />
                <button
                  type="button"
            ...
            <div>
              ...
              <div className="relative mt-1">
                <input
                  ...
                  className={inputClass(errors.confirmPassword).replace("mt-1", "") + " pr-10"}
                />
                <button
                  type="button"
