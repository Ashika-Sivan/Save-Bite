...
export default function VendorReapply() {
      ...
      <div className="mx-auto max-w-5xl">
        <div className="mb-8">
          <h1 className="text-2xl font-bold text-gray-900">
            Re-Apply for SaveBite Vendor Registration
          </h1>
          <p className="mt-1 text-sm text-gray-500">
            Update your business details and uploaded documents to re-submit your application for admin review.
          </p>
        </div>
          ...
          {step === 4 && (
            <div>
              ...
              <p className="mb-6 text-sm text-gray-500">
                Please double-check your updated details before submitting your application.
              </p>
              ...
              <div className="space-y-5">
                ...
                <div className="rounded-2xl border border-dashed bg-green-50 p-5 text-sm text-gray-600">
                  By submitting, your updated application enters our verification queue again.
          ...
          <div className="mt-10 flex items-center justify-between">
            ...
            {step < 4 ? (
              ...
              <button
                ...
                className="rounded-full bg-[#2E7C35] px-6 py-3 text-sm font-semibold text-white hover:bg-[#25682c] disabled:opacity-50"
              >
                {submitting ? "Submitting..." : "Re-Submit Application"}
              </button>
            )}
          </div>
        </div>
