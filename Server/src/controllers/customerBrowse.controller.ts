...
export class CustomerBrowseController {
    ...
    getLiveHotels = catchAsync(async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
    ...
    getLiveHotelMenu = catchAsync(async (req: AuthRequest, res: Response, next: NextFunction): Promise<void> => {
