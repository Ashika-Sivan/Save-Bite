...
export interface IDailyMenuService{
    ...
    addMenuItem(ownerId:string,menuId:string,data:IAddDailyMenuItemDTO,imageFile:Express.Multer.File):Promise<IDailyMenuResponseDTO>
    ...
    usePreviousMenu(ownerId:string,menuId:string):Promise<IDailyMenuResponseDTO>
