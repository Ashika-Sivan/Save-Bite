...
router.post( ROUTES.AUTH.REGISTER,authController.register.bind(authController));
...
router.post(ROUTES.AUTH.FORGOT_PASSWORD,authController.forgotPassword.bind(authController));
router.post(ROUTES.AUTH.RESET_PASSWORD,authController.resetPassword.bind(authController));
router.post(ROUTES.AUTH.UPDATE_PASSWORD,authMiddleware.authenticate,authController.updatePassword.bind(authController));
